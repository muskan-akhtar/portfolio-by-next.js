...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Handle form submission (could send data to a server, but we will just display success message here)
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/background.jpg')" }} // Add your background image here
      ></div>
        ...
        <div className="bg-white bg-opacity-90 p-6 sm:p-8 shadow-lg rounded-lg w-full max-w-md">
          ...
          {isSubmitted && (
            <div className="mb-4 p-4 bg-green-100 text-green-800 rounded-md">
              Your message has been successfully sent. Please wait for our response.
            </div>
          )}
